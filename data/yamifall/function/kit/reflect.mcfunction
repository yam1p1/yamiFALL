...
tellraw @s [{"color":"gray","text":"\n["},{"color":"yellow","text":"!"},"] ",{"color":"white","text":"あなたは"},{"bold":true,"color":"yellow","text":" リフレクト "},{"color":"white","text":"になりました！\n"}]
...
item replace entity @s armor.chest with diamond_chestplate[enchantments={levels:{"minecraft:thorns":3,"minecraft:projectile_protection":1,"minecraft:unbreaking":3}}] 1
item replace entity @s armor.legs with iron_leggings[enchantments={levels:{"minecraft:protection":1,"minecraft:projectile_protection":1,"minecraft:unbreaking":3}}] 1
item replace entity @s armor.feet with iron_boots[enchantments={levels:{"minecraft:protection":1,"minecraft:projectile_protection":1,"minecraft:unbreaking":3}}] 1

##Main Weapon
give @s diamond_sword[enchantments={levels:{"minecraft:sharpness":1,"minecraft:knockback":1,"minecraft:unbreaking":3}}] 1
...
give @s arrow 16
give @s shield[enchantments={levels:{"minecraft:thorns":1}}] 1
