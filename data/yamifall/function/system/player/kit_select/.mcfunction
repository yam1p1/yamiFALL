...
execute if score @s kit matches 3 run function yamifall:kit/tank
execute if score @s kit matches 4 run function yamifall:kit/witch
execute if score @s kit matches 5 run function yamifall:kit/builder
execute if score @s kit matches 6 run function yamifall:kit/neptune
execute if score @s kit matches 7 run function yamifall:kit/warrior
execute if score @s kit matches 8 run function yamifall:kit/flame
